...
int main()
{
    ...
    Tilemap *dungeontilemap = new Tilemap(dungeonmap, Dungeonset_tiles, gfx_tile_32_pixel, TILE_WIDTH, TILE_HEIGHT, dungeonmap_DRAW_WIDTH, dungeonmap_DRAW_HEIGHT, dungeonmap_HEIGHT, dungeonmap_WIDTH, dungeonmap_X_OFFSET, dungeonmap_Y_OFFSET, 0, 0);
